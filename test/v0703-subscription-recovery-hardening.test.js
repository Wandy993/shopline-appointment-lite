...
test('v0.8.0.3 only treats a healthy active subscription as cacheable', () => {
...
test('v0.8.0.3 inactive admin startup bypasses the normal subscription cache', async () => {
...
test('v0.8.0.3 reconciles activation, payment, and expiration webhooks with Partner API', async () => {
...
test('v0.8.0.3 admin automatically recovers a resumed archived session without continuous polling', async () => {
...
test('v0.8.0.3 documents the SHOPLINE upstream package-gate limitation', async () => {
