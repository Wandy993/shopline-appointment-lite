# Appointment Lite v0.6.0.2 Notification & Calendar Architecture
...
4. overlays v0.6.0.2 while preserving `.env`, `.shopline-cli.yml`, and the generated Theme App Extension directory;
