# Appointment Lite v0.6.0.3 Business Calendar UX Cleanup
...
4. overlays v0.6.0.3 while preserving `.env`, `.shopline-cli.yml`, and the generated Theme App Extension directory;
