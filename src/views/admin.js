...
<head>
  ...
  <link rel="stylesheet" href="/admin/styles.css?v=0.5.0-hotfix.1">
</head>
<body>
  <div class="app-shell">
    <aside class="sidebar">
  ...
  <script type="module" src="/admin/app.js?v=0.5.0-hotfix.1"></script>
</body>
</html>`;
}
