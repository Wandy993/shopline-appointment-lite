...
<head>
  ...
  <link rel="stylesheet" href="/admin/styles.css?v=0.5.3">
</head>
<body>
  <div class="app-shell">
    <aside class="sidebar">
    ...
    <div class="workspace">
      ...
      <main class="content">
        ...
        <section id="staffView" class="view hidden">
          ...
          <article class="panel staff-operations-panel"><div class="panel-head staff-operations-head"><div><span class="eyebrow">STAFF OPERATIONS</span><h2>Team schedule</h2><p>Review who is assigned today or jump to another date.</p></div><label class="staff-operations-date"><span>Date</span><input id="staffOperationsDate" type="date"></label></div><div id="staffOperationsList" class="staff-operations-list"><div class="empty-compact">Loading team schedule…</div></div></article>
  ...
  <script type="module" src="/admin/app.js?v=0.5.3"></script>
</body>
</html>`;
}
