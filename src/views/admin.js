...
<body>
    ...
    <div class="workspace">
      ...
      <main class="content">
        ...
        <section id="setupView" class="view hidden">
          <div class="page-heading"><div><span class="eyebrow">QUICK SETUP</span><h1>Launch Appointment Lite</h1><p>Complete the storefront connection first, then create a service and test the booking flow.</p></div><span class="status-badge success">Store connected</span></div>
          <div class="setup-layout">
            <article class="panel setup-steps">
              <div id="setupBlockStep" class="setup-step"><span>1</span><div><strong>Enable the Appointment Lite App Block</strong><p>Open the product template in the SHOPLINE theme editor, add or activate the Appointment Lite App Block, then save the theme.</p><div class="setup-step-actions"><a id="openThemeEditor" class="button-link primary disabled" href="#" target="_blank" rel="noopener noreferrer">Open theme editor ${icons.arrow}</a><button id="confirmAppBlock" class="secondary" type="button">I've enabled the App Block</button></div><p id="themeEditorHint" class="hint">Preparing your theme editor link…</p></div></div>
              <div id="setupServiceStep" class="setup-step"><span>2</span><div><strong>Create your first appointment service</strong><p>Select the SHOPLINE product customers will book, then configure duration, availability, location, and specialist.</p><button class="text-button" data-new-rule>Create a service ${icons.arrow}</button></div></div>
              <div id="setupTestStep" class="setup-step"><span>3</span><div><strong>Test the storefront booking flow</strong><p>Open the configured product page and submit one test booking. The booking should appear in Bookings.</p><a id="setupPreviewProduct" class="button-link secondary-link disabled" href="#" target="_blank" rel="noopener noreferrer">Preview bookable product ${icons.arrow}</a></div></div>
            </article>
            <aside class="panel diagnostics"><div class="diagnostic-icon">${icons.check}</div><h2>Quick setup</h2><p>New merchants should enable the App Block before creating a service so the storefront is ready when the first rule goes live.</p><span id="setupStoreId" class="setup-meta">Loading store…</span><ul><li>Step 1 connects the storefront App Block</li><li>Step 2 creates the first appointment service</li><li>Step 3 verifies the complete customer booking experience</li></ul></aside>
          </div>
        </section>
      </main>
    </div>
  ...
  <dialog id="quickstartDialog" class="modal quickstart-modal">
    ...
    <div class="modal-body quickstart-body">
      <div class="quickstart-progress"><div><strong id="quickstartProgressLabel">0 of 3 complete</strong><span>Start with the App Block so your storefront is ready before you publish a service.</span></div><div class="progress-track"><span id="quickstartProgress"></span></div></div>
      <div class="quickstart-steps">
        <article id="quickstartBlockStep" class="quickstart-step"><span class="quickstart-number" data-step="1">1</span><div><strong>Enable the Appointment Lite App Block</strong><p>Open the product template, activate the Appointment Lite App Block, and save the theme.</p><div class="setup-step-actions"><a id="quickstartThemeEditor" class="button-link primary disabled" href="#" target="_blank" rel="noopener noreferrer">Open theme editor ${icons.arrow}</a><button id="quickstartConfirmBlock" class="secondary" type="button">I've enabled the App Block</button></div></div></article>
        <article id="quickstartServiceStep" class="quickstart-step"><span class="quickstart-number" data-step="2">2</span><div><strong>Create your first appointment service</strong><p>Choose a SHOPLINE product and configure the available schedule.</p><button id="quickstartCreateService" class="secondary" type="button">Create a service ${icons.arrow}</button></div></article>
        <article id="quickstartTestStep" class="quickstart-step"><span class="quickstart-number" data-step="3">3</span><div><strong>Test a booking on your storefront</strong><p>Open the configured product and complete one test appointment.</p><a id="quickstartPreviewProduct" class="button-link secondary-link disabled" href="#" target="_blank" rel="noopener noreferrer">Preview bookable product ${icons.arrow}</a></div></article>
      </div>
    </div>
