...
<head>
  ...
  <link rel="stylesheet" href="/admin/styles.css?v=0.6.5">
</head>
<body>
  <div class="app-shell">
    <aside class="sidebar">
    ...
    <div class="workspace">
      ...
      <main class="content">
        ...
        <section id="bookingsView" class="view hidden">
          ...
          <div id="bookingTable" class="booking-table panel"><div class="table-head"><span>Customer & service</span><span>SHOPLINE order</span><span>Payment</span><span>Appointment</span><span>Date & time</span><span>Assignment</span><span></span></div><div id="bookingsList" aria-live="polite"></div></div>
        </section>
  ...
  <script type="module" src="/admin/app.js?v=0.6.5"></script>
</body>
</html>`;
}
