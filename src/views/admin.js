...
<head>
  ...
  <link rel="stylesheet" href="/admin/styles.css?v=0.6.6">
</head>
<body>
  <div class="app-shell">
    <aside class="sidebar">
    ...
    <div class="workspace">
      ...
      <main class="content">
        ...
        <section id="bookingsView" class="view hidden">
          ...
          <div id="bookingTable" class="booking-table panel"><div class="table-head"><span>Customer & service</span><span>SHOPLINE order</span><span>Date & time</span><span>Assignment</span><span>Payment</span><span>Appointment</span><span></span></div><div id="bookingsList" aria-live="polite"></div></div>
        </section>
    ...
    <form id="ruleForm" novalidate>
      ...
      <div class="modal-body">
        ...
        <section class="rule-step" data-rule-step="0">
          ...
          <div id="postPurchaseEntryCallout" class="post-purchase-entry-card hidden"><span class="post-purchase-entry-icon">${icons.email}</span><div class="post-purchase-entry-copy"><span class="post-purchase-entry-kicker">AFTER PAYMENT</span><strong>Private order scheduling link</strong><p>Appointment Lite waits for a paid SHOPLINE order, then emails the buyer a private scheduling link.</p><div class="post-purchase-entry-meta"><span>1 purchased unit = 1 appointment</span><span>SHOPLINE order stays unchanged</span></div></div></div>
  ...
  <script type="module" src="/admin/app.js?v=0.6.6"></script>
</body>
</html>`;
}
