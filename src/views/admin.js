...
<head>
  ...
  <link rel="stylesheet" href="/admin/styles.css?v=0.8.3&build=0.8.3">
</head>
<body>
  <div class="app-shell">
    <aside class="sidebar">
...
<div class="details-basics">
  ...
  <script type="module" src="/admin/app.js?v=0.8.3&build=0.8.3"></script>
</body>
</html>`;
}
