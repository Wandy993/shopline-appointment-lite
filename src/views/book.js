...
<head>
  ...
  <link rel="stylesheet" href="/book/assets/styles.css?v=0.5.1-hotfix.2">
</head>
<body data-rule-id="${String(ruleId).replace(/[^a-f\d]/gi, '')}">
  <main class="booking-shell">
    ...
    <section id="bookingView" class="booking-card hidden">
      ...
      <form id="bookingForm">
        <div class="form-section"><div class="section-heading"><span>01</span><div><strong id="scheduleHeading">Choose a time</strong><small id="timezoneText">Times use the store time zone.</small></div></div><div id="staffField" class="field staff-choice hidden"><span>Staff</span><div id="staffPicker" class="staff-picker"><button id="staffPickerButton" class="staff-picker-button" type="button" aria-haspopup="listbox" aria-expanded="false"><span id="staffPickerValue" class="staff-picker-value"><span class="staff-avatar customer small">?</span><span><strong>Choose staff</strong><small>Select a team member</small></span></span><span class="staff-picker-chevron">⌄</span></button><div id="staffPickerMenu" class="staff-picker-menu hidden" role="listbox"></div><input id="staffSelect" name="staffId" type="hidden"></div><small>Choose who you would like to book with. Availability updates automatically.</small></div><div class="field-grid schedule-grid"><label class="field"><span>Date</span><input id="bookingDate" name="date" type="date" required></label><div id="timeField" class="field"><span id="timeLabel">Time</span><div id="timeSlots" class="time-slots"><span class="muted">Choose a date first.</span></div></div></div><div id="selectedSessions" class="selected-sessions hidden"></div></div>
  ...
  <script type="module" src="/book/assets/app.js?v=0.5.1-hotfix.2"></script>
</body>
</html>`;
}
