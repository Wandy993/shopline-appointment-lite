...
function emailBrandHeader(settings) {
  ...
  return `<table role="presentation" width="100%" cellspacing="0" cellpadding="0" style="border-collapse:collapse;font-family:'Poppins',Arial,Helvetica,sans-serif"><tr><td width="40" valign="middle" style="width:40px;vertical-align:middle">${logo}</td><td width="14" style="width:14px;font-size:1px;line-height:1px">&nbsp;</td><td valign="middle" style="vertical-align:middle;color:#344861;font-size:15px;font-weight:700;line-height:20px">${escapeHtml(settings.brandName)}</td></tr></table>`;
}

function emailDocument(title, body, settings) {
  const webFonts = 'https://fonts.googleapis.com/css2?family=Jost:wght@500;600;700&family=Poppins:wght@400;500;600;700&display=swap';
  return `<!doctype html><html><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"><style>@import url('${webFonts}');body,table,td,div,p,a,span,strong{font-family:'Poppins',Arial,Helvetica,sans-serif!important}h1,h2{font-family:'Jost',Arial,Helvetica,sans-serif!important}</style></head><body style="margin:0;background:#F3F6FA;color:#172033;font-family:'Poppins',Arial,Helvetica,sans-serif"><div style="max-width:620px;margin:0 auto;padding:34px 16px;font-family:'Poppins',Arial,Helvetica,sans-serif"><div style="background:#fff;border:1px solid #E2E8F0;border-radius:16px;overflow:hidden"><div style="padding:20px 26px;border-bottom:1px solid #EEF2F6;font-family:'Poppins',Arial,Helvetica,sans-serif">${emailBrandHeader(settings)}</div><div style="padding:28px 26px 26px;font-family:'Poppins',Arial,Helvetica,sans-serif"><h1 style="font-family:'Jost',Arial,Helvetica,sans-serif;font-size:24px;line-height:1.3;margin:0 0 14px;color:#263A56;font-weight:600">${escapeHtml(title)}</h1>${body}<p style="margin:28px 0 0;padding-top:16px;border-top:1px solid #EEF2F6;color:#98A5B5;font-size:11px;font-family:'Poppins',Arial,Helvetica,sans-serif">Sent by ${escapeHtml(settings.brandName)}</p></div></div></div></body></html>`;
}
