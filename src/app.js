...
export function createApp() {
  ...
  app.get('/health', (req, res) => res.set('Cache-Control', 'no-store').json({ ok: true, service: 'appointment-lite', version: '0.8.11', build: '0.8.11-provider-brand-email-polish', release: 'v0.8.11-provider-brand-email-polish' }));
