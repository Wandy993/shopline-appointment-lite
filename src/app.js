...
export function createApp() {
  ...
  app.get('/health', (req, res) => res.set('Cache-Control', 'no-store').json({ ok: true, service: 'appointment-lite', version: '0.8.5', build: '0.8.5-booking-theme-system-modal-layout-fix', release: 'v0.8.5-booking-theme-system-modal-layout-fix' }));
