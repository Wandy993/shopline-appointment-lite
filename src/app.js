...
export function createApp() {
  ...
  app.get('/health', (req, res) => res.set('Cache-Control', 'no-store').json({ ok: true, service: 'appointment-lite', version: '0.8.0', build: '0.8.0-core-booking-staff.1', release: 'v0.8.0-core-booking-staff' }));
