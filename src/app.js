...
export function createApp() {
  ...
  app.get('/health', (req, res) => res.set('Cache-Control', 'no-store').json({ ok: true, service: 'appointment-lite', version: '0.7.0', build: '0.7.0-subscription.1', release: 'v0.7.0.7-shopline-new-window' }));
