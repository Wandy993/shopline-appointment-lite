...
export function createApp() {
  ...
  app.get('/health', (req, res) => res.set('Cache-Control', 'no-store').json({ ok: true, service: 'appointment-lite', version: '0.8.8', build: '0.8.8-online-meeting-delivery-completion', release: 'v0.8.8-online-meeting-delivery-completion' }));
