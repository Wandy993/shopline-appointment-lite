...
export function createApp() {
  ...
  app.get('/health', (req, res) => res.set('Cache-Control', 'no-store').json({ ok: true, service: 'appointment-lite', version: '0.8.7', build: '0.8.7-storefront-css-delivery-fix', release: 'v0.8.7-storefront-css-delivery-fix' }));
