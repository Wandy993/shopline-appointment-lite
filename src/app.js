...
export function createApp() {
  ...
  app.get('/health', (req, res) => res.set('Cache-Control', 'no-store').json({ ok: true, service: 'appointment-lite', version: '0.8.1', build: '0.8.1-booking-model-storefront-placement.1', release: 'v0.8.1-booking-model-storefront-placement' }));
